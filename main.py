...
import json
import asyncio
from agent import MultiAgentTeam, get_gemini_embedding, search_vector_db
...
<body>
    <div id="drop-overlay">DROP FILE TO INGEST</div>
    ...
    <script>
        ...
        // Chaos Mode Toggle
        const chaosToggle = document.getElementById('chaos-toggle'); // The first toggle is Chaos Mode in UI
        if(chaosToggle) {
